...
<section>
  <div>
    <ODB type="app" text="Vägen till företagare" keyword="rte" />
    <ODB type="app" text="Egen ekonomi" keyword="finances" />
  </div>
  <ODB type="namespace" text="MY VORTE" keyword="my_vorte" />
  <div>
    <ODB type="app" text="Uppgifter" keyword="tasks" />
    <ODB type="app" text="Scheman" keyword="tm" />
  </div>
</section>

<section>
  <div>
    <ODB type="app" text="Ekonomi" keyword="fms" />
    <ODB type="app" text="Marknadsföring" keyword="marketing" />
  </div>
  <ODB type="namespace" text="VORTEPRENEUR" keyword="vortepreneur" />
  <div>
    <ODB type="app" text="Projekt" keyword="pms" />
    <ODB type="app" text="Kundrelationer" keyword="crm" />
  </div>
</section>
